...
#if UNITY_EDITOR
[CustomEditor(typeof(StackableInventoryItem))]
public class StackableInventoryItemEditor : Editor
{
    private StackableInventoryItem inventoryItem;
    ...
    {
        inventoryItem = (StackableInventoryItem)target;
